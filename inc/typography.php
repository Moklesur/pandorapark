...
function themetim_typography_color($color) {
    ...
    $body_font_family = get_theme_mod( 'body_font_family', 'Asul' );
    ...
    $heading_font_family = get_theme_mod( 'heading_font_family', 'Asul' );
    ...
    $color .= ".request-account .request-button:hover,.navbar-default .navbar-nav>li>a,a,.woocommerce div.product .product_title,.woocommerce div.product p.price, .woocommerce div.product span.price,.woocommerce div.product form.cart .variations td.label { color:" . esc_attr($link_color) . "} ";

    $link_hover_color = get_theme_mod( 'link_hover_color', '#00e06d' );
    $color .= ".navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.active>a:focus, .navbar-default .navbar-nav>.active>a:hover,.navbar-default .navbar-nav>li>a:focus, .navbar-default .navbar-nav>li>a:hover,a:hover,.navbar-default .active a,.navbar-default .active a:hover, .navbar-default li> a:hover,.footer-main a:hover{ color:" . esc_attr($link_hover_color) . "} ";
    ...
    $footer_text_color = get_theme_mod( 'footer_text_color', '#444' );
    $color .= ".footer-main { background:" . esc_attr($footer_bg_color) . "} ";
    $color .= ".footer-main,.footer-main a,.footer-main h3,.footer-main h4  { color: ". esc_attr($footer_text_color) ."} ";

    /*
     * Default Button
     */
    $btn_default_bg = get_theme_mod( 'btn_default_bg', '#00e06d' );
    $btn_default_text = get_theme_mod( 'btn_default_text', '#fff' );
    $btn_default_border = get_theme_mod( 'btn_default_border', '#00e06d' );
     ...
     * Primary Button
     */
    $btn_primary_bg = get_theme_mod( 'btn_primary_bg', '#111' );
    $btn_primary_text = get_theme_mod( 'btn_primary_text', '#fff' );
    $btn_primary_border = get_theme_mod( 'btn_primary_border', '#111' );
    ...
    $btn_primary_bg_hover = get_theme_mod( 'btn_primary_bg_hover', '#00e06d' );
    $btn_primary_text_hover = get_theme_mod( 'btn_primary_text_hover', '#fff' );
    $btn_primary_border_hover = get_theme_mod( 'btn_primary_border_hover', '#00e06d' );
